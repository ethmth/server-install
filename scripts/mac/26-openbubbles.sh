...
# curl -o ~/Downloads/Mac.Hardware.Info.zip https://github.com/OpenBubbles/Mac-Hardware-Info/releases/latest/download/Mac.Hardware.Info.zip
# wget https://github.com/OpenBubbles/Mac-Hardware-Info/releases/latest/download/Mac.Hardware.Info.zip
# 
# cd ~/Downloads
